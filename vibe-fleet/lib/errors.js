...
export const ERROR_CODES = Object.freeze({
  ...
  // Fleet
  E_FLEET_NOT_FOUND: 'E_FLEET_NOT_FOUND',                       // no fleet config discoverable
  E_FLEET_SCHEMA_INVALID: 'E_FLEET_SCHEMA_INVALID',             // fleet config corrupted
  E_PROJECT_NOT_REGISTERED: 'E_PROJECT_NOT_REGISTERED',         // alias unknown
  E_PROJECT_ALREADY_REGISTERED: 'E_PROJECT_ALREADY_REGISTERED', // alias clash on register
  E_PROJECT_INVALID: 'E_PROJECT_INVALID',                       // path doesn't contain vibe-history.json
});
